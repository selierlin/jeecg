        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="报表类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="approvalType">
              <j-dict-select-tag type="list" v-model="model.approvalType" dictCode="approval_type"
                                 placeholder="请选择报表类型"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="收件时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="receiptTime">
              <j-date placeholder="请选择收件时间" v-model="model.receiptTime" :show-time="true"
          ...
          <a-col :span="24">
            <a-form-model-item label="返回时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="returnTime">
              <j-date placeholder="请选择返回时间" v-model="model.returnTime" :show-time="true"
                      date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
