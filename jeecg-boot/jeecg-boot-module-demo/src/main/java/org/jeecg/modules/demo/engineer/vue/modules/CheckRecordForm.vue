        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="巡查记录表名" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="sideName">
              <a-input v-model="model.sideName" placeholder="请输入巡查记录表名"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="结束时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="endTime">
              <j-date placeholder="请选择结束时间" v-model="model.endTime" :show-time="true"
                      date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="巡查人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="checkUser">
              <a-input v-model="model.checkUser" placeholder="请输入巡查人"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="文件" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="fileSource">
