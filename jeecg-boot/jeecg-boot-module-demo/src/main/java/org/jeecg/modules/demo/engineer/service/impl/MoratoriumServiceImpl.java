...
import org.jeecg.modules.demo.engineer.mapper.MoratoriumMapper;
 ...
 */
@Service
public class MoratoriumServiceImpl extends ServiceImpl<MoratoriumMapper, Moratorium> implements IMoratoriumService {

    private final static Logger logger = LoggerFactory.getLogger(MoratoriumServiceImpl.class);
    ...
    public Result<?> audit(String id, Integer isPass, String remark) {
        ...
        if (result.isSuccess()) {
            ...
            if (workFlowResult.isSuccess()) {
                boolean save = workFlowLogService.saveByTaskId(id, "MORATORIUM", isPass, stepId, remark);
