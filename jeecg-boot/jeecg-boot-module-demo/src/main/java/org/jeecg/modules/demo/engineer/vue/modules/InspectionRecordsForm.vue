        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="报表类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="inspectionType">
              <j-dict-select-tag type="list" v-model="model.inspectionType" dictCode="inspection_type" placeholder="请选择报表类型" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="验收结果" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="acceptResult">
              <j-dict-select-tag type="list" v-model="model.acceptResult" dictCode="check_result" placeholder="请选择验收结果" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
