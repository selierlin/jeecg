        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="旁站记录表名" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="sideName">
              <a-input disabled v-model="model.sideName" placeholder="请输入旁站记录表名"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="开始时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="startTime">
              <j-date disabled placeholder="请选择开始时间" v-model="model.startTime"  style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="结束时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="endTime">
              <j-date disabled placeholder="请选择结束时间" v-model="model.endTime"  style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="旁站人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="sideUser">
              <a-input disabled v-model="model.sideUser" placeholder="请输入旁站人"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
