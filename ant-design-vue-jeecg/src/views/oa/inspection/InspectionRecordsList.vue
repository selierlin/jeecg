  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'reportor',text:'报验人',dictCode:''})
        fieldList.push({type:'date',value:'reportTime',text:'报验时间'})
        fieldList.push({type:'string',value:'accepter',text:'验收人',dictCode:''})
        fieldList.push({type:'date',value:'acceptTime',text:'验收时间'})
        fieldList.push({type:'string',value:'acceptResult',text:'验收结果',dictCode:''})
