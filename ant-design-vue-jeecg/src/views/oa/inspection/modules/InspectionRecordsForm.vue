        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="报表类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="inspectionType">
              <a-input v-model="model.inspectionType" placeholder="请输入报表类型"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="报验内容" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="reportContent">
              <a-input v-model="model.reportContent" placeholder="请输入报验内容"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="报验人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="reportor">
              <a-input v-model="model.reportor" placeholder="请输入报验人"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="验收人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="accepter">
              <a-input v-model="model.accepter" placeholder="请输入验收人"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="验收结果" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="acceptResult">
              <a-input v-model="model.acceptResult" placeholder="请输入验收结果"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
